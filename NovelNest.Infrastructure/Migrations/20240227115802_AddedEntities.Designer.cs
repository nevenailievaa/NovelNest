...
namespace NovelNest.Infrastructure.Migrations
{
    ...
    [Migration("20240227115802_AddedEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NovelNest.Infrastructure.Data.Models.BookUserCurrentlyReading", b =>
                {
                    b.Property<int>("BookId")
                        .HasColumnType("int")
                        .HasComment("The current Book's Identifier");
            ...
            modelBuilder.Entity("NovelNest.Infrastructure.Data.Models.BookUserRead", b =>
                {
                    b.Property<int>("BookId")
                        .HasColumnType("int")
                        .HasComment("The current Book's Identifier");
            ...
            modelBuilder.Entity("NovelNest.Infrastructure.Data.Models.BookUserWantToRead", b =>
                {
                    b.Property<int>("BookId")
                        .HasColumnType("int")
                        .HasComment("The current Book's Identifier");
            ...
            modelBuilder.Entity("NovelNest.Infrastructure.Data.Models.CoverType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NovelNest.Infrastructure.Data.Models.Book", b =>
                {
                    b.HasOne("NovelNest.Infrastructure.Data.Models.CoverType", "CoverType")
                        .WithMany("Books")
